    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Адміністративна панель"><a href="/login"><span class="glyphicon glyphicon-asterisk" aria-hidden="true"></span></a></li>
            </ul>
        </div>
    </div>
</nav>