<div class='row col-md-8 col-md-offset-2'>
    ...
    <?php
        ...
        echo $this->Html->link("<strong>Забули пароль?</strong>", "/admin/login/password", array("class" => "pull-right", "escape" => false));
        echo $this->Form->end();
    ?>
    <p class='margin-top15'><?= "Немає аккаунту? ".$this->Html->link("Зареєструватися", "/admin/login/register"); ?></p>
    <?php
