<div class='row margin-top30'>
    <div class='col-md-6'>
        <?= $this->Html->link('Додати сторінку', '/user/pages/add', array('class' => 'btn btn-default')); ?>
    </div>
</div>
                        ...
                        $control = '
                            <div class="btn-group btn-group-xs">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    ...
                                    <li>'.$this->Html->link('Редагувати', '/user/pages/edit/'.$item['Page']['id']).'</li>
                                    <li>'.$this->Html->link('Видалити', '/user/pages/delete/'.$item['Page']['id'], array('confirm' => 'Вы впевнені?')).'</li>
                                </ul>
                            </div>
                        ';
